  ...
  <div class="row justify-content-center">
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Sloppy Joe Special: $25 </strong><br>Dive into savory nostalgia with this pizza, loaded with seasoned ground beef, tangy tomato sauce, and a melty cheese blend that brings the classic Sloppy Joe to your plate</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>The Sloppy Supreme: $23</strong><br>A feast of flavors with pepperoni, sausage, bell peppers, onions, and black olives, all layered over a rich tomato base and gooey mozzarella</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Jo's Zesty Trio: $23.50</strong><br>A bold combo of spicy pepperoni, earthy mushrooms, and fiery jalapeños, all on a bed of rich tomato sauce and bubbling cheese</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Sloppy's Carnivore Delight: $22</strong><br>Piled high with pepperoni, sausage, ham, and bacon, all perfectly balanced by a hearty tomato sauce and melted cheese</p>
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Jo's Mozz Sticks: $10</strong><br>A hearty pizza topped with seasoned beef, onions, and cheese</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Sloppy Buff Wings: $10</strong><br>6 piece: Juicy chicken wings coated in a tangy, spicy Buffalo sauce, served with a cooling side of ranch or blue cheese dressing</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        <img src="@/assets/orderBuffaloWings.png" alt="Buffalo Wings" class="card-img-top">
        <div class="card-body">
          <p class="card-text description"><strong>Sloppy Buff Wings: $16</strong><br>12 piece: Juicy chicken wings coated in a tangy, spicy Buffalo sauce, served with a cooling side of ranch or blue cheese dressing</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Cheesy Bread: $10</strong><br>Cheesy perfection with a crisp, golden crust and a gooey, melted center</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Garlic Bread:  $7</strong><br>Warm, golden breadsticks infused with rich garlic butter and sprinkled with Parmesan cheese—perfect for dipping</p>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card grid-item">
        ...
        <div class="card-body">
          <p class="card-text description"><strong>Sloppy Salad: $10</strong><br>Crisp romaine lettuce, shaved Parmesan, and crunchy croutons tossed in a creamy Caesar dressing</p>
